...
public class Main {
	...
	public static void main(String[] args) {
		try {
			...
			String filePath = "/Users/bob/Documents/-MINA_DOKUMENT/PLUGG/IT-AK-3/LP1-TDA384-Principles_of_Concurrent_Programming/Computer_resources/tsim/world/bin/tsim";
			String tsimCommand = String.format("%s --speed=%d %s", filePath, tsim_speed, map);
